...
// MAP LOGIN INTEGRATION: add the map provider SDK and authenticated client here.
// Keep provider keys in environment variables, then replace map-grid with the live map.
function MapCard() {
  return (
    ...
    <div className="content-grid ambulance-layout">
      ...
      <div className="workspace">
        ...
        <div className="status-strip">
          <span>
            <span className="live-dot" />
            Traffic sharing active
          </span>
          <span>
            <Hospital size={15} />
            Hospital channel ready
          </span>
          <span>
            <Clock3 size={15} />
...
function HospitalView({ sent, vitals, consciousness, setShowReferral }) {
  return (
      ...
      <div className="stats">
        {[
          ...
          <Glass className="stat" key={t}>
            ...
            <strong>{n}</strong>
            <small>
              {t === "ER beds" ? "Updated 4 min ago" : "Live today"}
            </small>
          </Glass>
        ))}
      </div>
        ...
        <Glass className="queue">
          ...
          {[
            ...
            <div className="queue-row" key={x}>
              <div className={`priority ${i ? "subdued" : ""}`}>{i + 1}</div>
              <div>
                <strong>{x}</strong>
                <span>
                  {i
              ...
              <Pill tone={i ? "warning" : "critical"}>
                {i ? "Review" : "High priority"}
              </Pill>
              <b>{8 + i * 5} min</b>
            </div>
          ))}
      ...
      <div className="traffic-map">
        ...
        <Glass className="ops-panel">
          ...
          {[
            ...
            <div className="operation" key={x[0]}>
